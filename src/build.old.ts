...
function compileColor(color: string, lightness: string) {
  if (color = "transparent"(
}

function compileBorder(style: string, color: string) {
...
function changePageLink() {
  ...
  switch (settings["css-theme"]) {
    case "Quattro":
      ...
      pageLinkBorderLightnessDark = 300;
      break;
  ...
  if (settings["css-page-link-color-lightness"] != "Theme Default") {
...
function changeExternalLink() {
  ...
  switch (settings["css-theme"]) {
    case "Quattro":
      ...
      externalLinkBorderLightnessDark = 300;
      break;
  ...
  if (settings["css-external-link-color-lightness"] != "Theme Default") {
...
function changeReferenceLink() {
  ...
  if (settings["css-reference-link-color-lightness"] != "Theme Default") {
