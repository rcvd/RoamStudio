...
echo "    css['roam-auto'] = '`cat src/RoamStudio/inline/roam-auto.css | tr '\n' ' '`';" >> src/index.ts
echo "    css['roam-common'] = '`cat src/RoamStudio/inline/roam-common.css | tr '\n' ' '`';" >> src/index.ts
echo "    css['roam-dark'] = '`cat src/RoamStudio/inline/roam-dark.css | tr '\n' ' '`';" >> src/index.ts
echo "    css['roam-light'] = '`cat src/RoamStudio/inline/roam-light.css | tr '\n' ' '`';" >> src/index.ts
